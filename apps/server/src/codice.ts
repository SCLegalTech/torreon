...
export const CODICE_INSTRUCTIONS = [
  ...
  "4. Cada paso declara la evidencia concreta que lo demuestra y de qué tipo es (file, link, screenshot, number, text, declaration). Prefiere artefactos verificables sobre declaraciones.",
    ...
    steps: {
      ...
      items: {
        ...
        properties: {
          ...
          evidenceKind: { type: "string", enum: ["file", "link", "screenshot", "number", "text", "declaration"] },
